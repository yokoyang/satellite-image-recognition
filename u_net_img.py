...
class U_net(object):
    ...
    def predict_all_class(self, general_building, tree_model, water_model, bare_land_model,
                          ...
                          road_model, shadow_model, img_id, dir_name):
        ...
        countryside_msk = self.predict_id(img=img, model=countryside_model, th=0.5)
        ...
        road_msk = self.predict_id(img=img, model=road_model, th=0.5)
        road_msk = road_msk[:, :, 0]
