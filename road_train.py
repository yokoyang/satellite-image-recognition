...
def post_normalize_image(img, mean=0.346092, std=0.176794):
    img = (img - mean) / std
    return img
...
for i in range(loop_time):
    ...
    check_point_file_name = str(loop_i) + '_rotate_val_jaccard_coef_int_road.hdf5'
